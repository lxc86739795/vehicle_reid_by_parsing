...
class NCEFunction(Function):
    ...
    def backward(self, gradOutput):
        ...
        gradOutput = gradOutput.mul(out)
        # add temperature
        # gradOutput.data.div_(T)
        gradOutput = gradOutput.div(T)
        ...
        weight_pos = weight_pos.mul(momentum)
        # weight_pos.add_(torch.mul(x.data, 1-momentum))
        weight_pos = weight_pos.add(torch.mul(x, 1-momentum))
