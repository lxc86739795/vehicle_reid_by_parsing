...
class VeRiWild_Small_Mask(ImageMaskDataset):
    """
    VeRi-Wild
    Reference:
    ...
    def __init__(self, root='/home/liuxinchen3/notespace/data', verbose=True, **kwargs):
        ...
        self.train_list = osp.join(root, self.dataset_dir, 'train_test_split_small/train_700.txt')
        self.query_list = osp.join(root, self.dataset_dir, 'train_test_split_small/test_300_query.txt')
        self.gallery_list = osp.join(root, self.dataset_dir, 'train_test_split_small/test_300.txt')
        ...
        super(VeRiWild_Small_Mask, self).__init__(train, query, gallery, **kwargs)
