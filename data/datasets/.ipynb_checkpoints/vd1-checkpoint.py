...
class VD1(ImageDataset):
    ...
    def __init__(self, root='/home/liuxinchen3/notespace/data', verbose=True, **kwargs):
        self.image_dir = osp.join(root, self.dataset_dir, 'VD1/image')
        self.train_list = osp.join(root, self.dataset_dir, 'VD1/train_test/trainlist.txt')
        self.test_list = osp.join(root, self.dataset_dir, 'VD1/train_test/testlist.txt')
